...
<form action="${pageContext.request.contextPath }/admin/AdminServlet" method="post"
      onsubmit="return false" onkeypress="if(13 === event.keyCode){jump();return false;}">
                        ...
                        <tr>
                            ...
                            <td height="20" bgcolor="#FFFFFF">
                                <div align="center" class="STYLE21">
                                        <%-- <a href="${pageContext.request.contextPath }/AdminServlet?op=deleteProduct&aid=${admin.aid}">删除</a> | --%>
                                    ...
                                    <td width="49">
                                        <div align="center">
                                            <span class="STYLE22"><a
                                                    href="${pageContext.request.contextPath }/admin/AdminServlet?op=findAllAdmin&num=${page.totalPageNum }">尾页</a></span>
                                        </div>
                                    </td>
...
<script type="text/javascript">
    function jump() {
        ...
        window.location.href = "${pageContext.request.contextPath }/admin/AdminServlet?op=findAllAdmin&num=" + num;
    }
</script>
</body>
</html>
